...
const PITCH_INDEXES :  {[key:string]: number} = {
  C: 0,
  'C#': 1,
  Db: 1,
  D: 2,
...
function buildMidiNumberAttributesCache() : MidiAttributes[] {
...
const midiNumberAttributesCache : MidiAttributes[] = buildMidiNumberAttributesCache();

// Returns an object containing various attributes for a given MIDI number.
// Throws error for invalid midiNumbers.
function getAttributes(midiNumber: number) : MidiAttributes {
 ...
 */
function midiToNoteName(midi: number, options: MidiNameOpts = { sharps: true, pitchClass: false }) {

...
import { secondaryColor } from '../utils/StyleConsts'
    ...
    return (
      <View
        style={[ styles.ReactPiano__Key,
          ...
          {
            left: ratioToPercentage(this.getRelativeKeyPosition(midiNumber) * naturalKeyWidth) as DimensionValue,
            width: ratioToPercentage(accidental ? accidentalWidthRatio * naturalKeyWidth : naturalKeyWidth) as DimensionValue
          },
